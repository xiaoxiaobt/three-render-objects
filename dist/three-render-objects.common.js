...
var threeRenderObjects = Kapsule__default["default"]({
  ...
  init: function init(domNode, state) {
    ...
    state.postProcessingComposer = new EffectComposer_js.EffectComposer(state.extraRenderers[0]);
  ...
  update: function update(state, changedProps) {
    ...
    if (changedProps.hasOwnProperty('backgroundColor')) {
      ...
      state.extraRenderers[0].setClearColor(new three.Color(polished.opacify(1, state.backgroundColor)), alpha);
    }
